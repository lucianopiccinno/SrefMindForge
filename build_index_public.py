...
OUTPUT_HTML = BASE_DIR / "index_public.html"
...
def main() -> None:
    ...
    # Versione pubblica: 300 SREF campionati (manuale:true priorità)
    import random as _rnd
    _sorted = sorted(slim_data, key=lambda x: (not x.get('manuale', False), _rnd.random()))
    slim_data = _sorted[:300]
    print(f"[PUBLIC] {len(slim_data)} SREF selezionati su {len(enriched)}")
